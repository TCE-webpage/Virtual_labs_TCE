...
function updateVDSlabel(min, max){
  const newGaugeDisplayValue = document.getElementById("VGSrange").value;
...
document.getElementById("VDSrange").style.display="none";
...
document.getElementById("tbvgs1").innerHTML = vds+" V";
...
function exportData(){
  ...
  /* add a new records in the array */
      ...
      link.setAttribute("download", "TransferCharacteristics.csv");
